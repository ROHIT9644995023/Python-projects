...
import os
from tkinter.constants import BOTH, RIGHT, TRUE
...
file = tk.Menu(main_menu, tearoff=False) # up down space please
...
edit = tk.Menu(main_menu, tearoff=False) # up down space please

##### view icons
tool_bar_icon = tk.PhotoImage(file='icons2/tool_bar.png')
status_bar_icon = tk.PhotoImage(file='icons2/status_bar.png')
view = tk.Menu(main_menu, tearoff=False) # up down space please
...
color_theme = tk.Menu(main_menu, tearoff=False) # up down space please

theme_choice = tk.StringVar()
color_icons = (light_default_icon, light_plus_icon, dark_icon, red_icon, monokai_icon, night_blue_icon, color_theme)
